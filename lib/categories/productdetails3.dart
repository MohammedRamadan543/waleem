...
// class ProductDetailsPage3 extends StatefulWidget {
//   final Map<String, dynamic> product;

//   const ProductDetailsPage3({super.key, required this.product});

//   @override
//   State<ProductDetailsPage3> createState() => _ProductDetailsPage3State();
// }

// class _ProductDetailsPage3State extends State<ProductDetailsPage3>
...
//                 child: Text(
//                   "${product["name"]} - كباب شوي حاشي - ${product["price"]}",
